...
class PsTsModal extends React.Component {
  ...
  render() {
    ...
    return (
          ...
          <Modal.Title>Book Consoles</Modal.Title>
          
              <Alert> 
                Please make sure that you are not booking more than 4 consoles for today, otherwise your money will be
                deducted but consoles will not be assigned. 
                to you.
              </Alert>
          ...
          <Modal.Body>            
            ...
            <Button disabled = {disabled[1]} bsStyle="primary" bsSize="small" style={{ margin: '4px'}} onClick={() => { this.handleTotalBooking(item, 'Playstation 2',30)}} >Playstation 2 </Button><br></br>
          </Modal.Body>
