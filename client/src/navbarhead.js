...
class NavbarHeader extends Component {
  render() {
    ...
    <Navbar inverse fixed='top' style = {{ width: '100%', background: 'none',border:'none'}} >
      <Navbar.Header> 
        <Navbar.Brand>
        <a href="http://stuc.iitr.ac.in/" style={navstyle}><img src={Background} alt='stuc logo' href='/' style={{width:"33%",}}></img></a>
        </Navbar.Brand>
      ...
      <Navbar.Collapse >
        ...
        <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/'>Home</MenuItem>
        <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/games.htm'>Games</MenuItem>
        <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/events.htm'>Events</MenuItem>
        <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/about_us.htm'>About Us</MenuItem>
          ...
          <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/notices.htm'>Notices</MenuItem>
          <MenuItem eventKey={3} href='http://stuc.iitr.ac.in/team.htm'>Team</MenuItem>
        </Nav>
      </Navbar.Collapse>
